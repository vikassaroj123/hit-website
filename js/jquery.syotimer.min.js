    ...
    var a = {
            ...
            _refreshUnitsDom: function(t) {
                ...
                for (var l = 0; l < r.length; l++) {
                    var c = r[l],
                        u = "." + c;
                    e(u + " .tab-val", i).html(s.format2(a[c], "day" != c ? o.doubleNumbers : !1)), e(u + " .tab-unit", i).html(s.definitionOfNumerals(a[c], d[c], o.lang))
                }
            },
        ...
        s = {
            ...
            getSecondsToDeadLine: function(e, t) {
                ...
                if (o = Math.floor(o), t.periodic) {
                    var n, r, a = s.getPeriodUnit(t.periodUnit),
                        d = e / (1e3 * a);
                    d = Math.ceil(d), d = Math.abs(d), o >= 0 ? (r = d % t.periodInterval, r = 0 == r ? t.periodInterval : r, r -= 1) : r = t.periodInterval - d % t.periodInterval, n = o % a, 0 == n && 0 > o && r--, i = Math.abs(r * a + n)
                } else i = o;
                return i
            },
            ...
            format2: function(e, t) {
                return t = t !== !1, 9 >= e && t ? "0" + e : "" + e
            },
            definitionOfNumerals: function(e, t, i) {
                switch (i) {
                    case "rus":
                        var o, n = [2, 0, 1, 1, 1, 2];
                        return o = e % 100 > 4 && 20 > e % 100 ? 2 : n[5 > e % 10 ? e % 10 : 5], t[o];
                    case "eng":
                        return t[1 == e ? 0 : 1]
                }
            }
